...
<Tabs>
  <TabItem value="basic" label="Basic Webservice" default>
    ...
    jobs:
      main:
        requires: [~commit]
        template: paion-data/jersey-webservice-basic-release-definition-template@latest
    ```
  ...
  <TabItem value="jpa" label="JPA Webservice">
    ...
    jobs:
      main:
        requires: [~commit]
        template: paion-data/jersey-webservice-jpa-release-definition-template@latest
    ```
