Immutable Infrastructure as a Service
=====================================
...
What is Immutable Infrastructure as a Service
---------------------------------------------

Immutable Infrastructure as a Service ("__IIaaS__") is a technology-agnostic framework for general Continuous
Delivery/Deployment onto AWS through HashiCorp
...
myself learning and that incubated the most important open source project of my life - [IIaaS]. It condensed my
